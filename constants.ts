...
export const DEFAULT_GPT_IMAGE_1_PROMPT_OBJECT: GptImage1PromptConfig = {
  n: 1,
  size: "1024x1024",
  quality: "medium",
  style: "vivid",
...
export const DEFAULT_GPT_IMAGE_2_PROMPT_OBJECT: GptImage2PromptConfig = {
  size: "1024x1024",
  quality: "high",
  n: 1,
  background: "auto",
...
export const DEFAULT_FLUX_PROMPT_OBJECT: FluxPromptConfig = {
  aspect_ratio: "1:1",
...
const defaultRealisticStyle = DzineStyles.find(s => s.name === "Realistic") || DzineStyles[0];

export const DEFAULT_DZINE_PROMPT_OBJECT: DzinePromptConfig = {
  style_code: defaultRealisticStyle.style_code,
  style_base_model: defaultRealisticStyle.style_base_model,
  style_intensity: defaultRealisticStyle.style_intensity,
  size: "1024x1024",
  n: 1,
  quality: "STANDARD",
  output_format: "webp"
...
export const DEFAULT_UPSCALER_PROMPT_OBJECT: StableImageUpscalerPromptConfig = {
  output_format: "webp"
};
...
export const HUMAN_NAME_MAP: Record<string, string> = {
  ...
  "flux-2-klein-4b": "Flux2-4B",
  "flux-2-klein-9b": "Flux2-9B",
  "dzine": "Dzine",
  "upscale": "Upscaled"
};
